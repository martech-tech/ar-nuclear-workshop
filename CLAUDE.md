...
- Educational copy lives in three places that must stay consistent: `LEARN_STEPS`/`QUIZ` in `js/ui.js`, the worksheet in `print.html`, and the answer key in `workshop.html`.
